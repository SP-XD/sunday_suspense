...
class VideosWidget extends StatelessWidget {
  const VideosWidget({super.key, required this.categoryId, required this.categoryType});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      key: UniqueKey(),
      create: (context) => VideosBloc(categoryId, context.read<VideosRepository>())
        ..add(VideosEvent.loadVideos(categoryId: categoryId, categoryType: categoryType)),
