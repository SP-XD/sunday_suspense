...
ChannelId _$ChannelIdFromJson(Map<String, dynamic> json) {
  return _ChannelId.fromJson(json);
}
...
mixin _$ChannelId {
  ...
  /// Serializes this ChannelId to a JSON map.
...
class _$ChannelIdImpl extends _ChannelId {
  ...
  factory _$ChannelIdImpl.fromJson(Map<String, dynamic> json) =>
      _$$ChannelIdImplFromJson(json);
...
abstract class _ChannelId extends ChannelId {
  ...
  factory _ChannelId.fromJson(Map<String, dynamic> json) =
      _$ChannelIdImpl.fromJson;
